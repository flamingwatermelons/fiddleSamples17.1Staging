         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                series: [{
                    ...
                    shapeDataSource: 'http://staging.igniteui.local/17-1/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'http://staging.igniteui.local/17-1/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
